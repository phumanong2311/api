...
module.exports = function (router) {
  router.get('/post', authUser.checkTokenAdmin, (req, res) => {
    try {
  ...
  router.get('/post/:id', authUser.checkTokenAdmin, (req, res) => {
    try {
      let { id } = req.params
  ...
  router.post('/post', authUser.checkTokenAdmin, (req, res) => {
    try {
      let data = req.body
      data['isDelete'] = false
  ...
  router.put('/post/:id', authUser.checkTokenAdmin, (req, res) => {
    try {
      let field = req.body
      delete field.id
  ...
  router.delete('/post/:id', authUser.checkTokenAdmin, (req, res) => {
    try {
      var { id } = req.params
