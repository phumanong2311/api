...
module.exports = function (router) {
  router.get('/collection/grid', authUser.checkTokenAdmin, (req, res) => {
    try {
      var obj = {
  ...
  router.post('/collection/form', authUser.checkTokenAdmin, (req, res) => {
    try {
   ...
   * params: code: String
   */
  router.get('/collection/code', authUser.checkTokenAdmin, (req, res) => {
    try {
  ...
  router.get('/collection/update', authUser.checkTokenAdmin, (req, res) => {
    try {
      var { data } = req.query
  ...
  router.get('/collection/delete', authUser.checkTokenAdmin, (req, res) => {
    try {
      var { code } = req.query
